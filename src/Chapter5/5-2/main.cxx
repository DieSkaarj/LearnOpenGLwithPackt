...
int main( int argv,char* argc[] ){
	...
	GLFWwindow *window{ glfwCreateWindow( WIDTH,HEIGHT,"Learn OpenGL: Chapter 5-2",nullptr,nullptr ) };
	...
	*Create vertex data
	...
	while( !glfwWindowShouldClose( window ) ){
		...
		*/
		...
		glUniform1f( glGetUniformLocation( lightingShader._Program,"light.linear" ),0.9 );
