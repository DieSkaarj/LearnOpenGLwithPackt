...
int main( int argv,char* argc[] ){
	...
	while( !glfwWindowShouldClose( window ) ){
		...
		transform=glm::rotate( transform,static_cast< GLfloat >( glfwGetTime()*-5.f ),glm::vec3( 0.f,0.f,1.f ) );

		GLint transformLocation{ glGetUniformLocation( ourShader._Program,"transform" ) };
